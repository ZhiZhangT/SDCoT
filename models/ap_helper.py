...
class APCalculator(object):
    ...
    def compute_metrics(self, dataset):
        ...
        gt_df = eval_gt_acc(self.pred_map_cls, self.gt_map_cls, ovthresh=self.ap_iou_thresh, img_id_to_check=7, save_dir="val_pred_bboxes", get_iou_func=get_iou_obb, dataset=dataset)
